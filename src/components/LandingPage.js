    ...
    <>
      <div className="flex min-h-screen flex-col items-center justify-between xl:p-24">
        ...
        <div className="h-auto flex pt-12 lg:py-0 px-4 xl:px-0 z-10 relative">
          <ul className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4 gap-x-4 gap-y-8 sm:gap-x-6 xl:gap-x-8">
            <li className="col-span-1 xl:col-span-2">
              ...
              <h2 className="max-w-2xl text-xl font-bold tracking-tight text-white pb-8 xl:pb-0 px-4 xl:px-0">
        ...
        <div className="flex flex-col w-full mt-10">
          ...
          <h2 className="text-xl font-bold text-left mt-4">Recently Added</h2>
          <Suspense
