...
export async function finalizeMovieCaptions(client, movie, aggregated) {
  ...
  for (const [lang, captionObj] of Object.entries(aggregated)) {
    ...
    if (!currentCaption ||
        ...
        Boolean(currentCaption.autoGenerated) !== Boolean(captionObj.autoGenerated) ||
        Boolean(currentCaption.pending) !== Boolean(captionObj.pending)) {
      ...
      finalCaptionURLs[lang] = {
        ...
        ...(captionObj.autoGenerated ? { autoGenerated: true } : {}),
        ...(captionObj.pending ? { pending: true } : {}),
      }
      changed = true
    }
  }
  ...
  for (const episode of season.episodes) {
    ...
    for (const [lang, capObj] of Object.entries(aggregatedForEpisode)) {
      ...
      if (!currentCaption ||
          ...
          Boolean(currentCaption.autoGenerated) !== Boolean(capObj.autoGenerated) ||
          Boolean(currentCaption.pending) !== Boolean(capObj.pending)) {
        ...
        finalCaptionURLs[lang] = {
          ...
          ...(capObj.autoGenerated ? { autoGenerated: true } : {}),
          ...(capObj.pending ? { pending: true } : {}),
        }
        changed = true
      }
    }
